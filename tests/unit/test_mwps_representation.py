"""
Unit tests for MwpsRepresentation (step 08).
...
def test_serialize_tools_mwps_format() -> None:
...
def test_register_mwps_models() -> None:
    """register_mwps_models registers representation for each model_id."""
    reg = RepresentationRegistry()
    register_mwps_models(reg, ["llama3.2", "qwen3"])
