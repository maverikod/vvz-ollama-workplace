"""
Unit tests for MwpsChatCommand: schema shape, execute result structure.
...
def test_get_metadata_returns_full_metadata() -> None:
    ...
    meta = MwpsChatCommand.get_metadata()
    assert meta["name"] == "mwps_chat"
    assert "description" in meta
    assert meta["params"] == MwpsChatCommand.get_schema()
...
async def test_execute_session_mode_uses_context_builder() -> None:
    ...
    from mwps.commands import mwps_chat_command as mod
