#!/usr/bin/env python3
"""
Minimal example: send one user message to the mwps_chat command and print the reply.

Author: Vasiliy Zdanovskiy
email: vasilyvz@gmail.com

Requires: server running with mwps registered (e.g. adapter with
register_mwps(registry)). Set MWPS_* env vars or
a config file so the server has proxy and MWPS URLs and model.
"""
...
async def main() -> None:
    # Adapter server (where mwps_chat is registered)
