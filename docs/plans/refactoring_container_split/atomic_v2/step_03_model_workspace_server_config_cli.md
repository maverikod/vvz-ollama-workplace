# Step 03: Model Workspace Server Config CLI

**Author:** Vasiliy Zdanovskiy  
**email:** vasilyvz@gmail.com

## Target file
- `src/model_workspace_server/config_cli.py`

## Dependencies
- [`step_02_model_workspace_server_config_validator.md`](./step_02_model_workspace_server_config_validator.md) (previous step in chain)
...
- Output suitable for prompt-based workflows and CI.
...
## Success metric
- Operator can generate and validate model workspace server config from terminal only.
