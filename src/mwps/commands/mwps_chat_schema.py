"""
JSON schemas and metadata for the mwps_chat command.
...
def get_mwps_chat_params_schema() -> Dict[str, Any]:
    """
    Get JSON schema for mwps_chat command parameters.
    ...
    return {
        ...
        "properties": {
            ...
            "model": {
                "type": "string",
                "description": (
                    "MWPS model name. Overrides the default from config "
                    "(e.g. llama3.2, qwen3)."
                ),
                "example": "llama3.2",
            },
        ...
        "description": (
            "Chat with MWPS; the model has access to MCP Proxy tools "
...
def get_mwps_chat_result_schema() -> Dict[str, Any]:
    """
    Get JSON schema for successful mwps_chat result.
...
def get_mwps_chat_error_schema() -> Dict[str, Any]:
    """
    Get JSON schema for mwps_chat error result.
...
def get_mwps_chat_metadata(name: str, description: str) -> Dict[str, Any]:
    """
    Build complete metadata for the mwps_chat command.
    ...
    return {
        ...
        "params": get_mwps_chat_params_schema(),
        "result_schema": get_mwps_chat_result_schema(),
        "error_schema": get_mwps_chat_error_schema(),
        "error_codes": [
            {
                "code": -32602,
            ...
            },
            {
                ...
                "when": "Chat flow or MWPS/proxy communication failed",
            },
        ],
        "examples": {
            "success": {
