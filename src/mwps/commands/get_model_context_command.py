...
class GetModelContextCommand(Command):
    ...
    Same pipeline as mwps_chat: messages and tools are serialized via the
    ...
    model-specific (e.g. MwpsRepresentation for MWPS models).
    """

    name = "get_model_context"
    descr = (
        "Return the exact final context sent to the model: messages and tools "
        "as in the MWPS request. Params: session_id (required), "
            ...
            "properties": {
                ...
                "content": {
                    ...
                    "description": (
                        ...
                        "as mwps_chat does when you pass content. If omitted, "
