"""
Adapter command: set_default_model — hot-swap runtime default MWPS model.
...
class SetDefaultModelCommand(Command):
    ...
    Pass model name to set; omit or pass empty to reset to config.mwps_model.
    """

    name = "set_default_model"
    descr = (
        "Set the runtime default MWPS model for new chats. No restart needed. "
