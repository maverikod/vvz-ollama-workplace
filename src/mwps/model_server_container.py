"""
Ensure model server (Model Workplace Server) Docker container is running: start if stopped,
...
# Default port exposed by Model Workplace Server in container
DEFAULT_MWPS_PORT = 11434


def ensure_model_server_container(
    container_name: str,
    image: str,
    host_port: int = DEFAULT_MWPS_PORT,
    container_port: int = DEFAULT_MWPS_PORT,
) -> bool:
    """
